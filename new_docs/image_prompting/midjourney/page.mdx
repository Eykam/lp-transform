...
One of the unique features of Midjourney compared to other AI image generators is its ability to create visually striking and artistically composed images. This is attributed to the model's specialized training, which enables it to produce high-quality images with specific artistic parameters (more about this in "Advanced Prompts" >
"Parameters").
...
<div style={{ textAlign: "center" }}>
  <Image
    ...
    height={1024}
    style={{ width: "350px", margin: "auto" }}
    alt="midjourney astronaut params" />
</div>
...
(learn more about Midjourney parameters in "Advanced Prompts" >
"Parameters")
...
<div style={{ textAlign: "center" }}>
  <Image
    ...
    height={1024}
    style={{ width: "350px", margin: "auto" }}
    alt="midjourney astronaut multi1" />
</div>
...
<div style={{ textAlign: "center" }}>
  <Image
    ...
    height={1024}
    style={{ width: "350px", margin: "auto" }}
    alt="midjourney astronaut multi2" />
</div>
...
<div style={{ textAlign: "center" }}>
  <Image
    ...
    height={1024}
    style={{ width: "350px", margin: "auto" }}
    alt="midjourney astronaut params a169" />
  &nbsp;
  <Image
    ...
    alt="midjourney astronaut params a12" />
</div>
...
<div style={{ textAlign: "center" }}>
  <Image
    ...
    height={1024}
    style={{ width: "350px", margin: "auto" }}
    alt="midjourney astronaut params c20" />
  &nbsp;
  <Image
    ...
    height={1024}
    style={{ width: "350px", margin: "auto" }}
    alt="midjourney astronaut params c80" />
</div>
...
<div style={{ textAlign: "center" }}>
  <Image
    ...
    height={1024}
    style={{ width: "350px", margin: "auto" }}
    alt="midjourney astronaut params q05" />
  &nbsp;
  <Image
    ...
    height={1024}
    style={{ width: "350px", margin: "auto" }}
    alt="midjourney astronaut params q2" />
</div>
...
<div style={{ textAlign: "center" }}>
  <Image
    ...
    height={1024}
    style={{ width: "350px", margin: "auto" }}
    alt="midjourney astronaut params seed123" />
  &nbsp;
  <Image
    src="/docs/assets/images_chapter/midjourney_astronaut_params_seed123.webp"
    className="img-docs"
...
<div style={{ textAlign: "center" }}>
  <Image
    ...
    height={1024}
    style={{ width: "350px", margin: "auto" }}
    alt="midjourney astronaut params s50" />
  &nbsp;
  <Image
    ...
    height={1024}
    style={{ width: "350px", margin: "auto" }}
    alt="midjourney astronaut params s900" />
</div>
...
<div style={{ textAlign: "center" }}>
  <Image
    ...
    alt="midjourney astronaut params v1" />
  &nbsp;
  <Image
    ...
    height={512}
    style={{ width: "220px", margin: "auto" }}
    alt="midjourney astronaut params v2" />
  &nbsp;
  <Image
    ...
    height={512}
    style={{ width: "220px", margin: "auto" }}
    alt="midjourney astronaut params v3" />
</div>
...
<div style={{ textAlign: "center" }}>
  <Image
    ...
    height={512}
    style={{ width: "350px", margin: "auto" }}
    alt="midjourney astronaut params sameseed" />
</div>
...
<div style={{ textAlign: "center" }}>
  <Image
    ...
    height={512}
    style={{ width: "220px", margin: "auto" }}
    alt="midjourney astronaut params tilegrid" />
  &nbsp;
  <Image
    ...
    height={1024}
    style={{ width: "220px", margin: "auto" }}
    alt="midjourney astronaut params tile" />
  &nbsp;
  <Image
    ...
    height={2048}
    style={{ width: "220px", margin: "auto" }}
    alt="midjourney astronaut params tilecomplete" />
</div>
