...
We will now cover our first prompting technique, _instruction prompting_(@efrat2020turking)(@mishra2022reframing). We have already seen simple instructions used in previous articles (e.g. getting an AI to solve the math problem). However,
